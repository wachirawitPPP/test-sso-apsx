const customTheme = {
  button: {
    base: "group relative  flex items-stretch justify-center rounded-md text-center p-0.5 text-center font-medium",
    fullSized: "w-full",
    color: {
  ...
  modal: {
    ...
    header: {
      ...
      title: "text-xl font-semibold text-white dark:text-white leading-[normal]",
      close: {
